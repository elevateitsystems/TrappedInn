  ...
  return (
    <div className="flex min-h-dvh bg-background">
      ...
      <aside className="hidden md:flex flex-col w-60 border-r border-border bg-sidebar shrink-0">
        ...
        >
          <img src="/logo.jpg" alt="Tapped Inn" className="w-9 h-9 object-contain shrink-0" style={{ filter: "invert(1)" }} />
        ...
        <div className="px-3 py-4 border-t border-border space-y-1">
          ...
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 w-full rounded-lg text-sm font-medium text-muted-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors cursor-pointer"
          >
      ...
      <div className="flex flex-col flex-1 min-w-0">
        <header className="md:hidden flex items-center justify-between px-4 py-3 border-b border-border bg-background/95 backdrop-blur sticky top-0 z-40">
          <Link href="/dashboard" className="flex items-center gap-2" title="Back to your dashboard">
            <img src="/logo.jpg" alt="Tapped Inn" className="w-7 h-7 object-contain" style={{ filter: "invert(1)" }} />
