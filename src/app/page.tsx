    ...
    <div className="relative flex items-center justify-center select-none">
      ...
      >
        ...
        <div
          ...
          style={{
            background: `linear-gradient(135deg, #1a1206 0%, #2a1f0a 50%, #111 100%)`,
          }}
        />
      ...
      <motion.div
        ...
        className="absolute -right-6 sm:-right-10 top-10 px-3 py-2 rounded-xl text-xs font-bold shadow-xl"
      ...
      <motion.div
        ...
        className="absolute -left-9 sm:-left-12 bottom-20 px-3 py-2 rounded-xl text-xs font-bold shadow-xl"
        style={{
          background: CARD2,
          color: GOLD,
...
export default function LandingPage() {
  ...
  return (
    ...
    >
      {/* Nav */}
      <nav
        className="sticky top-0 z-50 flex items-center justify-between px-4 sm:px-6 md:px-16 py-3 md:py-4"
        style={{
      ...
      >
        <Link href="/" className="flex items-center gap-2 min-w-0" title="Home">
          <Image
            src="/logo.jpg"
            alt="Tapped Inn"
            width={32}
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <Link
            href="/sign-up"
            className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold px-3 sm:px-4 py-2 rounded-lg transition-opacity hover:opacity-85 whitespace-nowrap"
            style={{ background: GOLD, color: "#000" }}
          >
            Get Tapped Inn
          </Link>
      ...
      {/* Hero */}
      <section className="relative overflow-hidden px-4 sm:px-6 md:px-10 lg:px-16 pt-16 sm:pt-20 md:pt-24 lg:pt-32 pb-16 sm:pb-20 md:pb-24">
        <div
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: "#999" }}
            >
              Professional networking tools that connect instantly. No apps, no
              hassle — just real connections that matter.
            </p>

            {/* Username */}
            <div
              className="flex flex-col sm:flex-row rounded-xl p-1.5 gap-2 mb-4"
              style={{
            ...
            >
              <div className="flex items-center flex-1 min-w-0">
                <span
                  className="pl-3 sm:pl-4 text-xs sm:text-sm whitespace-nowrap"
                  style={{ color: "#555" }}
                >
                  {base_url}/
                </span>
                ...
                <input
                  ...
                  className="flex-1 bg-transparent py-3 px-2 text-sm font-medium outline-none text-white min-w-0"
              ...
              <Link
                href={
                  username
                    ? `/sign-up?username=${encodeURIComponent(username)}`
                    : "/sign-up"
                }
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-lg font-bold text-sm transition-opacity hover:opacity-85 whitespace-nowrap"
                style={{ background: GOLD, color: "#000" }}
              >
                Claim yours
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: "#888" }}
            >
              Connect all your links, socials, stores, and contact info in one
              living profile. Customize your look and get more clicks — from
              anywhere, on any device.
            </p>
            <div className="space-y-3 mb-8">
              {[
                "Pick your username",
                "Add your links & contact info",
                "Customize your theme & header image",
                "Tap to share with anyone",
              ].map((step, i) => (
            ...
            <Link
              href="/sign-up"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-bold text-sm transition-opacity hover:opacity-85"
              style={{ background: GOLD, color: "#000" }}
            >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: "#888" }}
            >
              Add your unique Tapped Inn link to every platform where your
              audience lives. Use your Tapped Inn card to drive in-person
              connections back to your digital world.
            </p>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p
              ...
              style={{ color: "#888" }}
            >
              Track your engagement in real time. See which links get clicked,
              when taps happen, and who's connecting with you — so you can keep
        ...
        >
          ...
          >
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <h3 className="text-xl font-display font-black mb-1 text-white">
                Get your Tapped Inn Card
              </h3>
              <p className="text-sm" style={{ color: "#777" }}>
                One tap connects anyone to your profile. No app required. Order
                at <span style={{ color: GOLD }}>TappedInn.net</span>
              </p>
            </div>
            <div
      ...
      {/* Final CTA */}
      <section
        className="px-6 md:px-16 py-28 relative overflow-hidden"
      ...
      >
        ...
        >
          ...
          >
            <CheckCircle className="w-4 h-4" /> Free to start · No credit card
            needed
          </div>
          <h2
            className="font-display font-black tracking-tight mb-6 text-white"
            style={{ fontSize: "clamp(2.8rem, 7vw, 5rem)", lineHeight: 1.0 }}
          >
            READY TO
            <br />
            <span style={{ color: GOLD }}>GET TAPPED INN?</span>
          ...
          <p className="text-xl mb-10" style={{ color: "#888" }}>
            Create your profile in under a minute. Your Tapped Inn card does the
            rest.
          </p>
      ...
      <footer
        ...
        style={{ background: "#0a0a0a", borderTop: `1px solid ${BORDER}` }}
      >
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm" style={{ color: "#555" }}>
            Your new digital identity platform.
          </p>
          <a
            href="https://www.TappedInn.net"
            target="_blank"
